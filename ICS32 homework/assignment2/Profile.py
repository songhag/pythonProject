...
class Profile:
    ...
    functions in this class as you will need
    to make use of each of them in your program.

    When creating your program you will need to
    collect user input for the properties
    exposed by this class. A Profile class should
    ensure that a username and password
    ...
    def save_profile(self, path: str) -> None:
        ...
        if p.exists() and p.suffix == '.dsu':
            try:
                ...
                raise DsuFileError("Error while "
                                   "attempting to process the DSU file.", ex)
        else:
